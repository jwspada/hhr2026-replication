...
def calc_ucc(years):
    ...
    for year in years:
        ...
        #filename = PATH + "data/ucc/asset_ucc_qbi_" + str(year) + ".csv"
        #filename = PATH + "data/ucc/asset_ucc_" + str(year) + "_tauonly.csv"
        #filename = PATH + "data/ucc/asset_ucc_qbi_" + str(year) + "_tauonly.csv"
        #filename = PATH + "data/ucc/asset_ucc_" + str(year) + "_bonusonly.csv"
        # export to csv
