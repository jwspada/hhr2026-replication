...
qui{
	forvalues year = 1987/2023 {
		import delimited "${data}\ucc\asset_ucc_qbi_`year'_tauonly", clear
...
qui{
	forvalues year = 1987/2023 {
		import delimited "${data}\ucc\asset_ucc_`year'_tauonly", clear
		keeporder asset_name bea_asset_code tax_treat rho_mix metr_mix ucc_mix z_mix
		rename rho_mix rho_mix_tauonly
		rename metr_mix metr_mix_tauonly
		rename ucc_mix ucc_mix_tauonly
...
qui{
	forvalues year = 1987/2023 {
		import delimited "${data}\ucc\asset_ucc_`year'_bonusonly", clear
		keeporder asset_name bea_asset_code tax_treat rho_mix metr_mix ucc_mix z_mix
...
qui{
	forvalues year = 1987/2023 {
		import delimited "${data}\ucc\asset_ucc_qbi_`year'", clear
		keep if tax_treat == "non-corporate"
...
qui{
	forvalues year = 1987/2023 {
		import delimited "${data}\ucc\asset_ucc_`year'", clear
		keeporder asset_name bea_asset_code major_asset_group assets tax_treat y delta rho_mix metr_mix ucc_mix tax_wedge_mix z_mix
		gen year = `year'
		order year, first
...
foreach var in ikchange2017minus2016 ikchange2018minus2016 ikchange2019minus2016 ikchange2020minus2016 ikchange2021minus2016 ikchange2022minus2016 ikchange2023minus2016 invpctchg2017minus2016 invpctchg2018minus2016 invpctchg2019minus2016 invpctchg2020minus2016 invpctchg2021minus2016 invpctchg2022minus2016 invpctchg2023minus2016{
	// 1%
