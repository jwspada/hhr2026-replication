...
graph export "$output/fig10panelA.eps", replace
...
graph export "$output/fig10panelB.eps", replace
...
graph export "$output/fig11panelA.eps", replace
...
graph export "$output/fig11panelB.eps", replace
